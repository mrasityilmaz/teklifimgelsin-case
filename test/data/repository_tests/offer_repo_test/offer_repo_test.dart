...
void main() async {
  ...
  group('Offers Repository Fetch-ModelParse Tests', () {
    test('personalFinanceLoan Test', () async {
      final result = await offerRepository.getLoanOffersByType(loanType: LoanTypeEnum.personalFinanceLoan);
    ...
    test('houseLoan Test', () async {
      final result = await offerRepository.getLoanOffersByType(loanType: LoanTypeEnum.houseLoan);
    ...
    test('vehicleLoan Test', () async {
      final result = await offerRepository.getLoanOffersByType(loanType: LoanTypeEnum.vehicleLoan);
